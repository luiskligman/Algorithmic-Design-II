...
public class OrderSchedulerSimulator {
	...
	public static final String[] NAMES = { "Alicja Ulderico", "Philomel Olivette", "Ines Marleen", "Frauke George",
			"Goodwin Kendra", "Onesiphoros Davorka", "Albin Bao", "Nirmala Erna", "Imtiyaz Umar", "Marita Adel" };
	public static final String[] FOODS = { "Raisin and strawberry yoghurt", "Roquefort salad", "Mussels",
			"Cuttlefish with rice", "Sausage with berry salad", "Mulberry and broccoli salad", "Feta and apricot salad",
			"Chestnut and chorizo soup", "Spaghetti squash", "Cheddar and ham sandwich" };
